# UNITY_EDITOR_TOOLING.md - A Door Inside the Dark
...
The goal is to generate common Unity objects safely through Unity Editor APIs:
...
Use stable IDs aligned with `Docs/DECISIONS.md` / `.cursor/rules/adid-architecture-and-waves.mdc`, for example:

- `lore.green_thermos`
- `anchor.green_thermos`
- `pressure.main_floor.door_static`
- `room.main_floor.weight_of_door`
- `puzzle.weight_of_door`
...
8. Known limitations
9. Rollback notes
10. Whether `Docs/BUILD_LOG.md` was updated at the top
...
`notepad Docs\UNITY_EDITOR_TOOLING.md`

`notepad Docs\CURSOR_UNITY_WORKFLOW.md`
